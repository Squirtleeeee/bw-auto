...
1. 从 [Releases](../../releases) 下载 `bw-auto-v0.2.0.zip`
2. 解压到任意文件夹
3. 双击 `bw-auto.exe` — 浏览器自动弹出独立窗口，开箱即用

> exe 自带 Python 环境和所有依赖，电脑无需安装任何东西。Windows 7/10/11 均可。
...
启动后自动弹出独立浏览器窗口（Chrome/Edge 应用模式）。也可手动打开 `http://127.0.0.1:8765`：
